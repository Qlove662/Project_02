async function displayData() {
    ...
    const endPintGet = `https://api.giphy.com/v1/gifs/search?api_key=PjvdqKiTPO2mLJwv0Z5YBjdHulb8coGn&q=${searchTerm}&limit=27&offset=0&rating=g&lang=en&bundle=messaging_non_clips`;
    try {
